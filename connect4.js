...
Elm.Connect4.make = function (_elm) {
   "use strict";
   _elm.Connect4 = _elm.Connect4 || {};
   if (_elm.Connect4.values)
   return _elm.Connect4.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Connect4$Update = Elm.Connect4.Update.make(_elm),
   $Connect4$View = Elm.Connect4.View.make(_elm),
   ...
   var main = function () {
      var inbox = $Signal.mailbox($Connect4$Model.None);
      var model = A3($Signal.foldp,
      $Connect4$Update.update,
      $Connect4$Model.initialModel,
      inbox.signal);
      return A2($Signal.map,
      $Connect4$View.view(inbox.address),
      model);
   }();
   _elm.Connect4.values = {_op: _op
                          ,main: main};
   return _elm.Connect4.values;
};
Elm.Connect4 = Elm.Connect4 || {};
Elm.Connect4.Model = Elm.Connect4.Model || {};
Elm.Connect4.Model.make = function (_elm) {
   "use strict";
   _elm.Connect4 = _elm.Connect4 || {};
   _elm.Connect4.Model = _elm.Connect4.Model || {};
   if (_elm.Connect4.Model.values)
   return _elm.Connect4.Model.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Connect4.Model",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var initialModel = {_: {}
                      ...
                      A2($List.repeat,42,newSpace),
                      _L.range(0,41))
                      ,gameOver: false
                      ,turn: Player1
                      ,winner: $Maybe.Nothing};
   var MakeMove = function (a) {
      return {ctor: "MakeMove"
             ,_0: a};
   };
   var None = {ctor: "None"};
   _elm.Connect4.Model.values = {_op: _op
                                ,newSpace: newSpace
...
Elm.Connect4 = Elm.Connect4 || {};
Elm.Connect4.Update = Elm.Connect4.Update || {};
Elm.Connect4.Update.make = function (_elm) {
   "use strict";
   _elm.Connect4 = _elm.Connect4 || {};
   _elm.Connect4.Update = _elm.Connect4.Update || {};
   if (_elm.Connect4.Update.values)
   return _elm.Connect4.Update.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Connect4.Update",
   $Basics = Elm.Basics.make(_elm),
   $Connect4$Model = Elm.Connect4.Model.make(_elm),
         ...
         {case "MakeMove":
            return function () {
                 var newStatus = function () {
                    ...
                    switch (_v2.ctor)
                    {case "Player1":
                       return $Connect4$Model.Red;
                       case "Player2":
                       return $Connect4$Model.Blue;}
                    _U.badCase($moduleName,
                    "between lines 44 and 48");
                 }();
                 var idToUpdate = function () {
                    var findOpenSpace = function (at) {
                       return function () {
                          var _v3 = A2($Connect4$Util._op["!!"],
                          model.board,
                          at);
                          switch (_v3.ctor)
                          {case "Just":
                             return function () {
                                  var _v5 = _v3._0.status;
                                  switch (_v5.ctor)
                                  {case "Empty":
                                     return findOpenSpace(at + 7);}
                                  return at - 7;
                               }();
                             case "Nothing": return at - 7;}
                          _U.badCase($moduleName,
                    ...
                    action._0,
                    7);
                    var openSpace = findOpenSpace(column);
                    return _U.cmp(openSpace,
                    0) < 0 ? $Maybe.Nothing : $Maybe.Just(openSpace);
                 }();
                 ...
                 var toggleTurn = function (player) {
                    return function () {
                       switch (validMove)
                       {case false: return player;
                          case true: return function () {
                               switch (player.ctor)
                               {case "Player1":
                                  return $Connect4$Model.Player2;
                                  case "Player2":
                 ...
                 var updatedBoard = function () {
                    var updateStatus = function (space) {
                       return function () {
                          switch (idToUpdate.ctor)
                          {case "Just":
                             return _U.eq(space.id,
                               idToUpdate._0) ? _U.replace([["status"
                                                            ,newStatus]],
                               space) : space;
                             case "Nothing": return space;}
                          _U.badCase($moduleName,
                 ...
                 var checkForWinner = function () {
                    var checks = function () {
                       ...
                       return function () {
                          switch (idToUpdate.ctor)
                          {case "Just":
                             return A2($Connect4$Util.apply,
                               idToUpdate._0,
                               _L.fromArray([checkVerticals
                                            ,checkHorizontals
                                            ,checkDiagonalsA
                                            ,checkDiagonalsB]));
                             case "Nothing":
                 ...
                 var updatedGameOver = function () {
                    var updatedBoardStatus = A2($List.map,
                    function (_) {
                       return _.status;
                    },
                    updatedBoard);
                    return $List$Extra.notMember($Connect4$Model.Empty)(updatedBoardStatus) || !_U.eq(checkForWinner,
                    $Maybe.Nothing);
                 }();
                 return function () {
...
Elm.Connect4 = Elm.Connect4 || {};
Elm.Connect4.Util = Elm.Connect4.Util || {};
Elm.Connect4.Util.make = function (_elm) {
   "use strict";
   _elm.Connect4 = _elm.Connect4 || {};
   _elm.Connect4.Util = _elm.Connect4.Util || {};
   if (_elm.Connect4.Util.values)
   return _elm.Connect4.Util.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Connect4.Util",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $List$Extra = Elm.List.Extra.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var apply = F2(function (argument,
   functions) {
      return function () {
         switch (functions.ctor)
         {case "::":
            return A2($List._op["::"],
              functions._0(argument),
              A2(apply,
              argument,
              functions._1));
            case "[]":
   ...
   _elm.Connect4.Util.values = {_op: _op
                               ,apply: apply};
   return _elm.Connect4.Util.values;
};
Elm.Connect4 = Elm.Connect4 || {};
Elm.Connect4.View = Elm.Connect4.View || {};
Elm.Connect4.View.make = function (_elm) {
   "use strict";
   _elm.Connect4 = _elm.Connect4 || {};
   _elm.Connect4.View = _elm.Connect4.View || {};
   if (_elm.Connect4.View.values)
   return _elm.Connect4.View.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Connect4.View",
   $Basics = Elm.Basics.make(_elm),
   $Connect4$Model = Elm.Connect4.Model.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   model) {
      return function () {
         var winnerToString = function (winner) {
            return function () {
               switch (winner.ctor)
               {case "Just":
                  switch (winner._0.ctor)
                    {case "Player1":
                       return "Player 1 won! XD";
                       case "Player2":
                       return "Player 2 won! XD";}
                    break;
                  case "Nothing":
                  return "Nobody won.. -.-";}
               _U.badCase($moduleName,
         ...
         var makeSpace = function (space) {
            return function () {
               var _v3 = space.status;
               switch (_v3.ctor)
               {case "Blue":
                  return A2($Html.div,
                    _L.fromArray([$Html$Attributes.$class("blue")
                                 ...
                                 address,
                                 $Connect4$Model.MakeMove(space.id))]),
                    _L.fromArray([]));
                  case "Empty":
                  return A2($Html.div,
                    _L.fromArray([$Html$Attributes.$class("empty")
                                 ,A2($Html$Events.onClick,
                                 address,
                                 $Connect4$Model.MakeMove(space.id))]),
                    _L.fromArray([]));
                  case "Red": return A2($Html.div,
                    _L.fromArray([$Html$Attributes.$class("red")
                                 ,A2($Html$Events.onClick,
                                 address,
                                 $Connect4$Model.MakeMove(space.id))]),
                    _L.fromArray([]));}
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      function () {
                         var _v4 = model.gameOver;
                         switch (_v4)
                         {case false:
                            return _L.fromArray([$Html.text("Connect 4 - ")
                                                ,$Html.text(currentTurn)
                                                ,$Html.text("\'s Turn")]);
                            case true:
                            return _L.fromArray([A2($Html.ul,
                              _L.fromArray([]),
                              _L.fromArray([A2($Html.li,
                                           _L.fromArray([]),
                                           _L.fromArray([$Html.text("game over")]))
                                           ,A2($Html.li,
                                           _L.fromArray([]),
                                           _L.fromArray([$Html.text(winnerToString(model.winner))]))
                                           ,A2($Html.li,
                                           _L.fromArray([]),
                                           _L.fromArray([$Html.text("click refresh to try again")]))]))]);}
                         _U.badCase($moduleName,
   ...
   _elm.Connect4.View.values = {_op: _op
                               ,view: view};
   return _elm.Connect4.View.values;
};
Elm.Debug = Elm.Debug || {};
